...
<script type="text/javascript" src="scripts/gui.js">
</script>
...
<div class="content">
    <center><h2>Browse Items By Category</h2><hr/></center>
<p>Please use the navigation controls below to browse our database</p>
<p>
    <select name="page" id="page">
        <?php
            $range=category::get_range_category($category);
            if($range==0)
    ...
    <button id="load" name="load" onclick="fill_table_view(<?php echo "'".$category."'";?>)">Load</button>
